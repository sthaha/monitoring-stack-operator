...
replace github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring v0.58.0 => github.com/sthaha/prometheus-operator/pkg/apis/monitoring v0.58.101
